...
----------------------------------------------------------------------------------------------------------------
Code stolen and modified by RocketGod for TPP Badge - Argh! 
...
void ELECHOUSE_CC1101::setSpi(void){
  if (spi == 0){
  // Removed old default pin assignments - TPP Badge uses addSpiPin() to set custom pins
  // This prevents any conflicts with the hardware design
  }
}
/****************************************************************
